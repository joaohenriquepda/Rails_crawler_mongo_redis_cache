...
Rails.application.configure do
  ...
  # var_1 = [ 'http://example.com', /http:\/\/example.*/ ]
  # config.action_cable.allowed_request_origins = var_1
  ...
  # var = Syslog::Logger.new 'app-name'
  # config.logger = ActiveSupport::TaggedLogging.new(var)
